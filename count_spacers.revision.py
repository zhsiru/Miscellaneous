...
###usage python count_spacers.revision.py -f MI.M06648_0094.001.gRNALib2_Oct20_LL_R1.fastq -o test.withg.17-26 -i sgRNA.library.10K.seq -no-g
...
KEY_REGION_END = 300 #end index of key region
